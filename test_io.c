...
static SageSlot sage_global_io_1;

void sage_gc_mark_program_globals(void) {
    if (sage_global_io_1.defined) sage_gc_mark_value(sage_global_io_1.value);
}
...
static SageValue sage_fn_main_2() {
    ...
    sage_print_ln(sage_call_method(sage_load_slot(&sage_global_io_1, "io"), "exists", 1, (SageValue[]){sage_string("hello.bat")}));
    sage_print_ln(sage_native_io_readfile(sage_string("hello.bat")));
...
int main(int argc, char** argv) {
    ...
    sage_global_io_1 = sage_slot_undefined();
    SageSlot* sage_gc_global_roots[1] = {&sage_global_io_1};
    SageGcFrame sage_gc_main_frame;
    sage_gc_push_frame(&sage_gc_main_frame, sage_gc_global_roots, 1);
    sage_define_slot(&sage_global_io_1, sage_init_native_module("io"));
    (void)sage_fn_main_2();
